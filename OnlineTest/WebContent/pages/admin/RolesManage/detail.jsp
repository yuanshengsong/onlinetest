...
<html lang="zh-cn">
	...
	<body>
		<div class="panel admin-panel">
			...
			<table class="table table-hover text-left">
				...
				<%
					...
					String rolse_idStr = request.getParameter("rolse_id");
					int rolse_id = Integer.parseInt(rolse_idStr);
					Roles rolse = rolseDAO.getById(rolse_id);
					
				%>
					<tr>
					<td><%=rolse.getRoles_id()%></td>
					<td><%=rolse.getRoles_name() %></td>
					<td><%=rolse.getRoles_note()%></td>
				</tr>
		...
		<div class="field">
			<a href="<%=request.getContextPath() %>/pages/admin/RolseManage/Rolselist.jsp"><button class="button bg-main icon-check-square-o" type="submit"> 返回</button></a>
		</div>
		</div>
