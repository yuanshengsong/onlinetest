...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-left table-bordered table-striped" id="dataTable">
    ...
    <tr>
      ...
      <td>信息工程1、2班</td>
      <td>
     	<a href="<%=request.getContextPath()%>/pages/admin/InformationManagement/TclassManagement/modify.html"><button class="button border-main" type="button"><span class="icon-edit"></span>修改</button></a>
