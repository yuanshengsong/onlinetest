...
<div class="panel admin-panel">
  ...
  <div class="panel admin-panel">
    <div><strong class="icon-reorder"> 开课列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a  class="button border-yellow icon-plus-square-o" href="add.html"> 添加开课</a> </li>
        <li >搜索：</li>
        <li>系部
    ...
    <table class="table table-hover text-left table-bordered table-striped" id="dataTable">
    	...
    	<tr>
	      ...
	      <td></td>
	      <td>
      	    <a href="<%=request.getContextPath()%>/pages/admin/InformationManagement/OcourseManagement/modify.html"><button class="button border-main" type="button"><span class="icon-edit"></span>修改</button></a>
	    ...
	    <tr>
	      ...
	      <td></td>
	      <td>
      	    <a href="/examOline/pages/admin/InformationManagement/OcourseManagement/modify.html"><button class="button border-main" type="button"><span class="icon-edit"></span>修改</button></a>
		    <a href="javascript:void(0)" onclick="return del(17)"><button class="button border-red" type="button"><span class="icon-trash-o"></span>删除</button></a>
      	  </td>
	    </tr>
